...
def plot_and_stuff(X_test, y_test, X_train, y_train, ax, type = 'frst', k_neighbours = 0):
    if type == 'frst':
...
plot_and_stuff(X_test, y_test, X_train, y_train, ax1, 'frst')
plot_and_stuff(X_test, y_test, X_train, y_train, ax2, 'tree')
plot_and_stuff(X_test, y_test, X_train, y_train, ax3, 'knn')
